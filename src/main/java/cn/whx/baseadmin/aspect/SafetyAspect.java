package cn.whx.baseadmin.aspect;

import cn.whx.baseadmin.common.pojo.Result;
import cn.whx.baseadmin.util.AesUtil;
import cn.whx.baseadmin.util.ErrorUtil;
import cn.whx.baseadmin.util.RsaUtil;
...
public class SafetyAspect {
     ...
     */
    @Pointcut(value = "execution(public * cn.whx.baseadmin.sys.*.controller.*.*(..)) || " +
            "execution(public * cn.whx.baseadmin.*.controller.*.*(..))")
